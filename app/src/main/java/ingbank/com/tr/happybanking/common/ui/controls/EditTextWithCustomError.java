...
import ingbank.com.tr.happybanking.common.ui.inputwatcher.BaseTextWatcher;


public class EditTextWithCustomError extends EditText implements
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mErrorIcon == null) {
//            mErrorIcon = context.getResources().getDrawable(R.drawable.pm_general_warning_icon);
        }

        if (mErrorBackground == null) {
//            mErrorBackground = context.getResources().getDrawable(R.drawable.pm_tooltip_orange);
        }
        if (mErrorBackgroundAbove == null) {
//            mErrorBackgroundAbove = context.getResources().getDrawable(R.drawable.pm_tooltip_orange);
        }
        this.addTextChangedListener(new BaseTextWatcher(this));
    }
    ...
    public void setError(CharSequence error, Drawable icon) {
        try {
            CharSequence spannedError = TextUtils.stringOrSpannedString(error);
            mError = spannedError;
        } catch (Exception ex) {
            ex.printStackTrace();
            hasFallen = true;
    ...
    protected void showError() {
        ...
        if (mPopup == null) {
            ...
            err.setTextColor(getContext().getResources().getColor(R.color.white));
    ...
    protected void onFocusChanged(boolean focused, int direction, Rect previouslyFocusedRect) {
        ...
        if (focused) {
            if (mError != null && !getText().toString().trim().equals(Constants.EMPTY_STRING)) {
                showError();
            }
        } else {
            if (mError != null) {
    ...
    protected boolean setFrame(int l, int t, int r, int b) {
        ...
        if (!hasFallen && mPopup != null) {
            TextView tv = (TextView) mPopup.getContentView();
            chooseSize(mPopup, mError, tv);
            mPopup.update(this, getErrorX(), getErrorY() + 10,
