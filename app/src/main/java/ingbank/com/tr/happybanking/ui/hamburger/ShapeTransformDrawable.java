...
public class ShapeTransformDrawable {
    ...
    private Runnable mAnimator = new Runnable() {
        ...
        private void updateTransform(float interpolator) {
            ...
            mState.RColor = mBeginState.RColor + (int) ((mTagetState.RColor - mBeginState.RColor) * interpolator);
            mState.GColor = mBeginState.GColor + (int) ((mTagetState.GColor - mBeginState.GColor) * interpolator);
            mState.BColor = mBeginState.BColor + (int) ((mTagetState.BColor - mBeginState.BColor) * interpolator);
    ...
    public void draw(Canvas canvas) {
        if (mShape != null) {
            ...
            mPaint.setColor(Color.rgb(mState.RColor, mState.GColor, mState.BColor));
