package ingbank.com.tr.happybanking.common.ui.blurbehind;
...
import ingbank.com.tr.happybanking.common.ui.blurbehind.util.Blur;
...
public class BlurBehind {
    ...
    public void setBackground(Activity activity,View background){
        if (mImageCache.size() != 0) {
            BitmapDrawable bd = new BitmapDrawable(activity.getResources(), mImageCache.get(KEY_CACHE_BLURRED_BACKGROUND_IMAGE));
            bd.setAlpha(mAlpha);
            if (mFilterColor != -1) {
