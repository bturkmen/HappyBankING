...
import ingbank.com.tr.happybanking.common.ui.pull_to_refresh.sdk.Compat;
import ingbank.com.tr.happybanking.common.ui.smooth_progress_bar.SmoothProgressBar;
...
public class DefaultHeaderTransformer extends HeaderTransformer {
    ...
    private void setupViewsFromStyles(Activity activity, View headerView) {
        ...
        if (styleAttrs.hasValue(R.styleable.PullToRefreshHeader_ptrSmoothProgressBarStyle)) {
            int spbStyleRes = styleAttrs.getResourceId(R.styleable.PullToRefreshHeader_ptrProgressBarStyle, 0);
            if (spbStyleRes != 0)
