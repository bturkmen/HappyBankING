package ingbank.com.tr.happybanking.common.ui.material_progress_bar;
...
public class MaterialProgressBar extends View {
    ...
    private List<MaterialProgressBarListener> listeners;
    ...
    public static MaterialProgressBar create(Context context, int defStyle) {
        MaterialProgressBar dialog = new MaterialProgressBar(context, null, defStyle);
        dialog.setLayoutParams(new RelativeLayout.LayoutParams(40, 40));
        dialog.autostartAnimation = true;
        dialog.setIndeterminate(true);
        dialog.setThickness(7);
        return dialog;
    }

    protected void init(AttributeSet attrs, int defStyle) {
        listeners = new ArrayList<MaterialProgressBarListener>();
    ...
    private void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        currentProgress = a.getFloat(R.styleable.MaterialProgressBar_cpv_progress,
                resources.getInteger(R.integer.cpv_default_progress));
        maxProgress = a.getFloat(R.styleable.MaterialProgressBar_cpv_maxProgress,
                resources.getInteger(R.integer.cpv_default_max_progress));
        thickness = a.getDimensionPixelSize(R.styleable.MaterialProgressBar_cpv_thickness,
                resources.getDimensionPixelSize(R.dimen.cpv_default_thickness));
        isIndeterminate = a.getBoolean(R.styleable.MaterialProgressBar_cpv_indeterminate,
                resources.getBoolean(R.bool.cpv_default_is_indeterminate));
        autostartAnimation = a.getBoolean(R.styleable.MaterialProgressBar_cpv_animAutostart,
        ...
        if (a.hasValue(R.styleable.MaterialProgressBar_cpv_color)) {
            color = a.getColor(R.styleable.MaterialProgressBar_cpv_color, resources.getColor(R.color.cpv_default_color));
        }
        ...
        animDuration = a.getInteger(R.styleable.MaterialProgressBar_cpv_animDuration,
                resources.getInteger(R.integer.cpv_default_anim_duration));
        animSwoopDuration = a.getInteger(R.styleable.MaterialProgressBar_cpv_animSwoopDuration,
                resources.getInteger(R.integer.cpv_default_anim_swoop_duration));
        animSyncDuration = a.getInteger(R.styleable.MaterialProgressBar_cpv_animSyncDuration,
                resources.getInteger(R.integer.cpv_default_anim_sync_duration));
        animSteps = a.getInteger(R.styleable.MaterialProgressBar_cpv_animSteps,
    ...
    public void setIndeterminate(boolean isIndeterminate) {
        ...
        if (old != isIndeterminate) {
            for (MaterialProgressBarListener listener : listeners) {
    ...
    /**
     * Sets the duration of the progress bar arc.
     *
     * @param animDuration the duration of the progress bar arc
     */
    ...
    /**
     * Register a MaterialProgressBarListener with this View
     *
     * @param listener The listener to register
     */
    public void addListener(MaterialProgressBarListener listener) {
        if (listener != null)
            listeners.add(listener);
    }

    /**
     * Unregister a MaterialProgressBarListener with this View
     *
     * @param listener The listener to unregister
     */
    public void removeListener(MaterialProgressBarListener listener) {
